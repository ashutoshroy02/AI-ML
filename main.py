...
Medical Report: Must Analyze the medical report given in markdown format and explain the user its report with data 
Traits:
...
st.title(":green[Chronic Compounder]")
...
url="https://4797-35-197-22-213.ngrok-free.app/"    #add_url
